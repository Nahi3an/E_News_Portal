...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark " style=" background-color:#24262b;">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="./user_dashboard.php">User Profile</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/online_news_portal/user/user_fav.php">Favourites</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/online_news_portal/user/user_liked.php">Liked News</a>
                    </li>
                    <li class="nav-item">
